...
Le projet dispose d'une architecture modulaire permettant l'intégration facile de nouveaux fournisseurs de paiement. Consultez la [documentation d'intégration](./docs/integration-checklist.md) pour plus de détails sur:
