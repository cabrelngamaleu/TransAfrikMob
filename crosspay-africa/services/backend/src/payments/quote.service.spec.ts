...
describe('QuoteService', () => {
  ...
  describe('calculateQuote', () => {
    ...
    it('should throw error for unsupported country', () => {
      ...
      expect(() => service.calculateQuote(quoteRequest)).toThrow('Pays source non pris en charge');
    });
  });
  ...
  describe('detectCountryFromPhone', () => {
    ...
    it('should throw error for unsupported country code', () => {
      expect(() => service.detectCountryFromPhone('+33600000000')).toThrow('Pays non pris en charge');
    });
  });
