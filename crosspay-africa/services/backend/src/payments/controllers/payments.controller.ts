...
export class PaymentsController {
  ...
  @Post('quote')
  @ApiOperation({ summary: 'Obtenir un devis pour un paiement transfrontalier' })
  @ApiResponse({ status: 201, description: 'Devis généré avec succès', type: QuoteResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Statut du paiement récupéré avec succès' })
