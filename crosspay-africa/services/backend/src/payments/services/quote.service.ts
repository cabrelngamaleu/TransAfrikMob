...
export class QuoteService {
  ...
  async generateQuote(
    ...
    const recipientCountry = this.detectCountryFromPhone(
      quoteRequest.recipientPhone
    );

    // Obtenir la devise du destinataire
    const destinationCurrency =
      this.countryCurrencies[recipientCountry] ||
      this.countryCurrencies.default;

    // Obtenir les rails disponibles pour ce pays
    const availableRails =
      this.countryRails[recipientCountry] || this.countryRails.default;
